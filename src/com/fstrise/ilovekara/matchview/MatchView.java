 ...
 * FIXME
 */
@SuppressLint("NewApi") public class MatchView extends View {
    //
    ...
    private float mInTime = 0.8f;//划入时间(�?��?秒)
    private float mOutTime = 0.8f;//划出时间(�?��?秒)
    private boolean isBeginLight = true;//结�?��?�是�?�播放动画（默认为是）
